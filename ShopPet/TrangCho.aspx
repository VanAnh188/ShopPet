...
<body>
    <div class="app">
        ...
        <!-- ảnh bìa -->
         <div class="anhbia">
            <img src="./assest/img/cho.png" alt="hình ảnh" class="img_bia">
        </div> 
        <br><br>
        <!-- danh mục  -->
        <div class="content">
        ...
        <!-- menu dọc bên trái -->
                <div class="sidebar_one">
                    ...
                    <img src ="./assest/img/cho-01.png" alt="Ảnh bìa" style="max-width:100%; height:auto; margin-top: 30px;"/>                    
                    <img src ="./assest/img/cho-02.png" alt="Ảnh bìa" style="max-width:100%; height:auto; margin-top: 30px;"/>
                </div>
            </div>
